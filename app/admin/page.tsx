  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
      {kpis.map((k) => (
        <div
          key={k.label}
          className="bg-slate-900/70 backdrop-blur-xl border border-slate-800/80 rounded-2xl px-6 py-5 text-center hover:border-slate-700/60 hover:-translate-y-1 transition-all duration-200 hover:shadow-2xl shadow-xl will-change-transform"
...
הדף באוויר לזמן מוגבל לצורך התרשמות. אם תרצו להעלות אותו באופן קבוע לרשת תחת הדומיין שלכם — סמסו לי חזרה ונרים אותו יחד בלחיצת כפתור!`;
  ...
  return (
    <div className="bg-slate-900/70 backdrop-blur-xl border border-slate-800/80 rounded-2xl p-6 flex flex-col gap-4 hover:border-slate-700/60 hover:-translate-y-1 transition-all duration-200 hover:shadow-2xl shadow-xl font-heebo will-change-transform" style={{ transform: "translateZ(0)" }}>
      ...
      <div className="flex flex-col sm:flex-row items-start justify-between gap-3">
        ...
        <span className={`shrink-0 text-xs font-semibold px-3 py-1.5 rounded-full border backdrop-blur-sm ${nicheMeta.color} font-heebo will-change-transform`} style={{ transform: "translateZ(0)" }}>
          {nicheMeta.label}
        </span>
      </div>
      ...
      <div className="flex items-center gap-3 bg-slate-800/50 border border-slate-700/40 rounded-lg px-3 py-2.5 hover:border-slate-700/60 transition-colors will-change-transform" style={{ transform: "translateZ(0)" }}>
        <span className={`w-3 h-3 rounded-full shrink-0 ${statusMeta.dot} animate-pulse will-change-transform`} style={{ transform: "translateZ(0)" }} />
        <select
          value={status}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
        <a
          ...
          className="flex items-center justify-center gap-1.5 bg-slate-800/50 border border-slate-700/40 hover:bg-slate-700 hover:border-slate-700/60 text-slate-200 text-xs font-semibold py-2.5 rounded-lg transition-all duration-200 hover:shadow-lg font-heebo will-change-transform"
          style={{ transform: "translateZ(0)" }}
        >
